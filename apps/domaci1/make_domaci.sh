...
sudo cp apps/domaci1/testnomod.tst tmp_hd/root
sudo cp apps/domaci1/testshift.tst tmp_hd/root
sudo cp apps/domaci1/testctrl.tst tmp_hd/root
sudo cp apps/domaci1/testalt.tst tmp_hd/root
